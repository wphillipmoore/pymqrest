...
MAPPING_DATA: dict[str, object] = {'commands': {'ALTER AUTHINFO': {'qualifier': 'authinfo', 'status': 'provisional'},
 ...
 'qualifiers': {'apstatus': {'request_key_map': {'application_type': 'TYPE'},
                             'request_value_map': {},
                ...
                'authinfo': {'request_key_map': {'adopt_context': 'ADOPTCTX',
                                                 'auth_info_conn_name': 'CONNAME',
                                                 'auth_info_desc': 'DESCR',
                             ...
                             'response_key_map': {'ADOPTCTX': 'adopt_context',
                                                  ...
                                                  'CHCKCLNT': 'checkclient',
                                                  'CHCKLOCL': 'checklocal',
                                                  'CLASSGRP': 'class_group',
                                                  'CLASSUSR': 'classuser',
                                                  'CONNAME': 'auth_info_conn_name',
                                                  'DESCR': 'auth_info_desc',
                ...
                'authrec': {'request_key_map': {'authority_add': 'AUTHADD',
                            ...
                            'request_value_map': {},
                            'response_key_map': {'AUTHLIST': 'authorization_list', 'ENTTYPE': 'entity_type'},
                            'response_value_map': {}},
                ...
                'channel': {'request_key_map': {'amqp_keep_alive': 'AMQPKA',
                                                ...
                                                'clwl_channel_priority': 'CLWLPRTY',
                                                'clwl_channel_rank': 'CLWLRANK',
                                                'clwl_channel_weight': 'CLWLWGHT',
                                                'command_scope': 'CMDSCOPE',
                                                ...
                                                'max_msg_length': 'MAXMSGL',
                                                'mca_name': 'MCANAME',
                                                'mca_type': 'MCATYPE',
                                                'mca_user_identifier': 'MCAUSER',
                                                'message_compression': 'COMPMSG',
                                                'mode': 'MODE',
                                                'mode_name': 'MODENAME',
                                                'msg_exit': 'MSGEXIT',
                                                'msg_retry_count': 'MRRTY',
                                                'msg_retry_exit': 'MREXIT',
                                                'msg_retry_interval': 'MRTMR',
                                                'msg_retry_user_data': 'MRDATA',
                                                'msg_seq_number': 'SEQNUM',
                                                'msg_user_data': 'MSGDATA',
                                                'network_priority': 'NETPRTY',
                                                'non_persistent_msg_speed': 'NPMSPEED',
                                                'password': 'PASSWORD',
                                                'port': 'PORT',
                            ...
                            'response_key_map': {'AFFINITY': 'connection_affinity',
                                                 ...
                                                 'CLUSTER': 'cluster_name',
                                                 'CLWLPRTY': 'clwl_channel_priority',
                                                 'CLWLRANK': 'clwl_channel_rank',
                                                 'CLWLWGHT': 'clwl_channel_weight',
                                                 ...
                                                 'MCANAME': 'mca_name',
                                                 'MCATYPE': 'mca_type',
                                                 'MCAUSER': 'mca_user_identifier',
                                                 'MODENAME': 'mode_name',
                                                 'MONCHL': 'channel_monitoring',
                                                 'MRDATA': 'msg_retry_user_data',
                                                 'MREXIT': 'msg_retry_exit',
                                                 'MRRTY': 'msg_retry_count',
                                                 'MRTMR': 'msg_retry_interval',
                                                 'MSGDATA': 'msg_user_data',
                                                 'MSGEXIT': 'msg_exit',
                                                 'NETPRTY': 'network_priority',
                                                 'NPMSPEED': 'non_persistent_msg_speed',
                                                 'PASSWORD': 'password',
                                                 'PORT': 'port',
                ...
                'chstatus': {'request_key_map': {'channel_disposition': 'CHLDISP',
                             ...
                             'request_value_map': {},
                             'response_key_map': {'AMQPKA': 'keep_alive_interval',
                                                  'BATCHES': 'batches',
                                                  'BATCHSZ': 'batch_size',
                                                  ...
                                                  'SSLCERTI': 'ssl_cert_user_id',
                                                  'SSLCERTU': 'ssl_cert_user_id',
                                                  'SSLCIPH': 'ssl_cipher_specification',
                                                  'SSLKEYDA': 'ssl_key_reset_date',
                                                  'SSLKEYTI': 'ssl_key_reset_time',
                                                  'SSLPEER': 'ssl_short_peer_name',
                                                  ...
                                                  'XQMSGSA': 'msgs_available',
                                                  'XQTIME': 'xq_time'},
                             'response_value_map': {}},
                'clusqmgr': {'request_key_map': {'channel': 'CHANNEL',
                                                 'cluster_name': 'CLUSTER',
                                                 'command_scope': 'CMDSCOPE'},
                             'request_value_map': {},
                             'response_key_map': {'CLUSDATE': 'cluster_date',
                                                  'CLUSTIME': 'cluster_time',
                                                  'DEFTYPE': 'q_mgr_definition_type',
                                                  'QMID': 'q_mgr_identifier',
                                                  'QMTYPE': 'q_mgr_type',
                                                  'STATUS': 'channel_status',
                                                  'SUSPEND': 'suspend',
                                                  'VERSION': 'version',
                ...
                'entauth': {'request_key_map': {'group_name': 'GROUP',
                                                ...
                                                'service_component': 'SERVCOMP'},
                            'request_value_map': {},
                            'response_key_map': {'AUTHLIST': 'authorization_list',
                                                 'ENTTYPE': 'entity_type',
                                                 'OBJTYPE': 'object_type'},
                            'response_value_map': {}},
                'group': {'request_key_map': {'obsolete_db2_msgs': 'OBSMSGS'},
                          'request_value_map': {},
                          'response_key_map': {},
                          'response_value_map': {}},
                ...
                'pubsub': {'request_key_map': {'command_scope': 'CMDSCOPE', 'type': 'TYPE'},
                           'request_value_map': {},
                           'response_key_map': {'QMNAME': 'queue_manager_name',
                                                'STATUS': 'status',
                                                'SUBCOUNT': 'sub_count',
                ...
                'qmgr': {'request_key_map': {'accounting_conn_override': 'ACCTCONO',
                                             ...
                                             'max_uncommitted_msgs': 'MAXUMSGS',
                                             'mqi_accounting': 'ACCTMQI',
                                             'mqi_statistics': 'STATMQI',
                                             'msg_mark_browse_interval': 'MARKINT',
                                             ...
                                             'pub_sub_clus': 'PSCLUS',
                                             'pub_sub_max_msg_retry_count': 'PSRTYCNT',
                                             'pub_sub_np_input_msg': 'PSNPMSG',
                         ...
                         'response_key_map': {'ACCTCONO': 'accounting_conn_override',
                                              ...
                                              'LUNAME': 'lu_name',
                                              'MARKINT': 'msg_mark_browse_interval',
                                              'MAXCHL': 'max_channels',
                                              'MAXHANDS': 'max_handles',
                                              'MAXMSGL': 'max_msg_length',
                                              'MAXPROPL': 'max_properties_length',
                                              'MAXPRTY': 'max_priority',
                                              'MAXUMSGS': 'max_uncommitted_msgs',
                                              'MEDIALOG': 'media_recovery_log',
                                              ...
                                              'PSCLUS': 'pub_sub_clus',
                                              'PSMODE': 'pub_sub_mode',
                                              'PSNPMSG': 'pub_sub_np_input_msg',
                                              'PSNPRES': 'pub_sub_np_response',
                                              'PSRTYCNT': 'pub_sub_max_msg_retry_count',
                                              ...
                                              'RECLOG': 'media_recovery_log',
                                              'RECSZ': 'media_recovery_log_size',
                ...
                'queue': {'request_key_map': {'authrec': 'AUTHREC',
                                              ...
                                              'cf_structure': 'CFSTRUCT',
                                              'cluster_channel_name': 'CLCHNAME',
                                              'cluster_namelist': 'CLUSNL',
                                              'clwl_queue_priority': 'CLWLPRTY',
                                              'clwl_queue_rank': 'CLWLRANK',
                                              'clwl_use_q': 'CLWLUSEQ',
                                              'command_scope': 'CMDSCOPE',
                                              'custom': 'CUSTOM',
                                              'def_bind': 'DEFBIND',
                                              ...
                                              'msg_delivery_sequence': 'MSGDLVSQ',
                          ...
                          'response_key_map': {'ACCTQ': 'queue_accounting',
                                               ...
                                               'CLUSTIME': 'cluster_time',
                                               'CLWLPRTY': 'clwl_queue_priority',
                                               'CLWLRANK': 'clwl_queue_rank',
                                               'CLWLUSEQ': 'clwl_use_q',
                                               'CONNAME': 'connection_name',
                                               'CRDATE': 'cluster_date',
                                               'CRTIME': 'cluster_time',
                                               ...
                                               'MONQ': 'queue_monitoring',
                                               'MSGAGE': 'oldest_msg_age',
                                               'MSGDLVSQ': 'msg_delivery_sequence',
                                               ...
                                               'TRIGMPRI': 'trigger_msg_priority',
                                               'TRIGTYPE': 'trigger_type',
                                               'TYPE': 'q_type',
                                               'UNCOM': 'uncommitted_msgs',
                                               'URID': 'user_identifier',
                                               'URTYPE': 'cluster_q_type',
                                               'USAGE': 'usage',
                                               'USERID': 'user_identifier',
                                               'XMITQ': 'xmit_q_name'},
                ...
                'sbstatus': {'request_key_map': {'command_scope': 'CMDSCOPE',
                             ...
                             'response_key_map': {'ACTCONN': 'active_connection',
                                                  'DURABLE': 'durable',
                                                  'LMSGDATE': 'last_publish_date',
                                                  'LMSGTIME': 'last_publish_time',
                ...
                'security': {'request_key_map': {'command_scope': 'CMDSCOPE',
                             ...
                             'response_key_map': {},
                             'response_value_map': {}},
                'service': {'request_key_map': {'from_service_name': 'LIKE',
                                                'ignore_state': 'IGNSTATE',
                                                'replace': 'REPLACE',
                                                'service_desc': 'DESCR',
                ...
                'smds': {'request_key_map': {'access': 'ACCESS',
                                             'cf_struc_name': 'CFSTRUCT',
                                             'ds_bufs': 'DSBUFS',
                                             'ds_expand': 'DSEXPAND',
                                             'status': 'STATUS'},
                         'request_value_map': {},
                         'response_key_map': {'CFSTRUCT': 'cf_struc_name',
                                              'DSBUFS': 'ds_bufs',
                                              'DSEXPAND': 'ds_expand',
                                              'SMDS': 'smds'},
                         'response_value_map': {}},
                'smdsconn': {'request_key_map': {'cf_struc_name': 'CFSTRUCT', 'command_scope': 'CMDSCOPE'},
                             'request_value_map': {},
                             'response_key_map': {},
                             'response_value_map': {}},
                'stgclass': {'request_key_map': {'command_scope': 'CMDSCOPE',
                             ...
                             'response_value_map': {}},
                'sub': {'request_key_map': {'command_scope': 'CMDSCOPE',
                                            'destination': 'DEST',
                                            ...
                                            'published_application_identifier': 'PUBAPPID',
                                            'selector': 'SELECTOR',
                                            'sub_id': 'SUBID',
                                            'sub_name': 'SUBNAME',
                                            'subscription_level': 'SUBLEVEL',
                                            'subscription_user': 'SUBUSER',
                        ...
                        'request_value_map': {},
                        'response_key_map': {'CMDSCOPE': 'command_scope',
                                             'DEST': 'destination',
                                             ...
                                             'PUBAPPID': 'published_application_identifier',
                                             'PUBPRTY': 'publish_priority',
                                             'SELECTOR': 'selector',
                                             'SUBID': 'sub_id',
                                             'SUBLEVEL': 'subscription_level',
                                             'SUBSCOPE': 'subscription_type',
                                             'SUBTYPE': 'subscription_type',
                                             'SUBUSER': 'subscription_user',
                ...
                'svstatus': {'request_key_map': {},
                             'request_value_map': {},
                             'response_key_map': {'PID': 'process_id',
                                                  'STARTARG': 'start_arguments',
                                                  'STARTCMD': 'start_command',
                                                  'STARTDA': 'start_date',
                                                  'STARTTI': 'start_time',
                                                  ...
                                                  'STOPCMD': 'stop_command'},
                             'response_value_map': {}},
                'system': {'request_key_map': {'command_scope': 'CMDSCOPE', 'exclmsg': 'EXCLMSG', 'service': 'SERVICE'},
                           'request_value_map': {},
                           'response_key_map': {},
                           'response_value_map': {}},
                ...
                'topic': {'request_key_map': {'authrec': 'AUTHREC',
                                              ...
                                              'def_persistence': 'DEFPSIST',
                                              'def_priority': 'DEFPRTY',
                                              'def_put_response': 'DEFPRESP',
                                              'ignore_state': 'IGNSTATE',
                                              'multicast': 'MCAST',
                                              'non_persistent_msg_delivery': 'NPMSGDLV',
                                              'persistent_msg_delivery': 'PMSGDLV',
                          ...
                          'response_key_map': {'ALTDATE': 'alteration_date',
                                               ...
                                               'CLUSTER': 'cluster_name',
                                               'CUSTOM': 'custom',
                                               'DEFPRESP': 'def_put_response',
                                               'DEFPRTY': 'def_priority',
                                               'DEFPSIST': 'def_persistence',
                                               'DESCR': 'durable_subscriptions',
                                               'DURSUB': 'durable_subscriptions',
                                               'MCAST': 'multicast',
                                               'NPMSGDLV': 'non_persistent_msg_delivery',
                                               'PMSGDLV': 'persistent_msg_delivery',
                                               'PROXYSUB': 'proxy_subscriptions',
                                               'PUB': 'cluster_pub_route',
                                               'PUBSCOPE': 'publication_scope',
                                               'SUB': 'cluster_pub_route',
