...
MAPPING_DATA: dict[str, object] = {
    ...
    "qualifiers": {
        ...
        "cfstatus": {
            "request_key_map": {"shared_message_dataset": "SMDS"},
            "request_value_map": {},
            "response_key_map": {
                "ACCESS": "access",
        ...
        "qmgr": {
            "request_key_map": {
                ...
                "default_cluster_xmit_queue_type": "DEFCLXQ",
                "default_xmit_queue_name": "DEFXMITQ",
                "description": "DESCR",
            ...
            "response_key_map": {
                ...
                "DEFCLXQ": "default_cluster_xmit_queue_type",
                "DEFXMITQ": "default_xmit_queue_name",
                "DESCR": "description",
        ...
        "queue": {
            ...
            "request_value_map": {"default_persistence": {"def": "DEF", "not_fixed": "NOTFIXED"}},
            "response_key_map": {
                "ACCTQ": "queue_accounting",
                "ALTDATE": "alteration_date",
                "ALTTIME": "alteration_time",
