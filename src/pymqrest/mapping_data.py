...
MAPPING_DATA: dict[str, object] = {
    "commands": {
        ...
        "DISPLAY QMSTATUS": {"qualifier": "qmstatus", "response_parameter_macros": ["LOG"], "status": "provisional"},
        "DISPLAY QSTATUS": {"qualifier": "qstatus", "response_parameter_macros": ["MONITOR"], "status": "provisional"},
