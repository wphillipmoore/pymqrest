...
MAPPING_DATA: dict[str, object] = {
    "commands": {
        "ALTER AUTHINFO": {"qualifier": "authinfo", "status": "provisional"},
        ...
        "DISPLAY QSTATUS": {"qualifier": "queue", "response_parameter_macros": ["MONITOR"], "status": "provisional"},
        "DISPLAY QUEUE": {"qualifier": "queue", "response_parameter_macros": ["CLUSINFO"], "status": "provisional"},
    ...
    "qualifiers": {
        ...
        "authinfo": {
            ...
            "request_key_value_map": {
                ...
                "replace": {"no": {"key": "REPLACE", "value": "NO"}, "yes": {"key": "REPLACE", "value": "YES"}},
            },
            "request_value_map": {},
            "response_key_map": {
        ...
        "bsds": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "buffpool": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "cfstatus": {
            "request_key_map": {"shared_msg_dataset": "SMDS"},
            "request_value_map": {},
            "response_key_map": {
                "ACCESS": "access",
        ...
        "channel": {
            ...
            "request_key_value_map": {
                "channel_instance_type": {
                    "current": {"key": "CURRENT", "value": "YES"},
                    "saved": {"key": "SAVED", "value": "YES"},
                    "short": {"key": "SHORT", "value": "YES"},
                },
                "noreplace": {"yes": {"key": "REPLACE", "value": "NO"}},
                "replace": {"no": {"key": "REPLACE", "value": "NO"}, "yes": {"key": "REPLACE", "value": "YES"}},
            },
        ...
        "chstatus": {
            ...
            "request_key_value_map": {
                ...
                "monitor": {"no": {"key": "MONITOR", "value": "NO"}, "yes": {"key": "MONITOR", "value": "YES"}},
            },
            "request_value_map": {},
            "response_key_map": {
                "AMQPKA": "amqp_keep_alive",
        ...
        "clusqmgr": {
            "request_key_map": {"channel_name": "CHANNEL", "cluster_name": "CLUSTER", "command_scope": "CMDSCOPE"},
            "request_value_map": {},
            "response_key_map": {
        ...
        "cmdserv": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "comminfo": {
            "request_key_map": {
                "bridge": "BRIDGE",
        ...
        "group": {
            "request_key_map": {"obsolete_db2_messages": "OBSMSGS"},
            "request_value_map": {},
            "response_key_map": {},
            "response_value_map": {},
        },
        ...
        "maxsmsgs": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "namelist": {
            "request_key_map": {
                "command_scope": "CMDSCOPE",
                "description": "DESCR",
        ...
        "psid": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "pubsub": {
            "request_key_map": {"command_scope": "CMDSCOPE", "type": "TYPE"},
            "request_value_map": {},
            "response_key_map": {
                "QMNAME": "q_mgr_name",
                "STATUS": "status",
        ...
        "qmgr": {
            "request_key_map": {
                "accounting_conn_override": "ACCTCONO",
            ...
            "request_value_map": {},
            "response_key_map": {
                "ACCTCONO": "accounting_conn_override",
        ...
        "queue": {
            ...
            "request_key_value_map": {
                "nopurge": {"yes": {"key": "PURGE", "value": "NO"}},
                "noreplace": {"yes": {"key": "REPLACE", "value": "NO"}},
                "purge": {"no": {"key": "PURGE", "value": "NO"}, "yes": {"key": "PURGE", "value": "YES"}},
                "replace": {"no": {"key": "REPLACE", "value": "NO"}, "yes": {"key": "REPLACE", "value": "YES"}},
            },
        ...
        "sbstatus": {
            "request_key_map": {"command_scope": "CMDSCOPE", "durable": "DURABLE", "subscription_type": "SUBTYPE"},
            "request_value_map": {},
            "response_key_map": {
        ...
        "smdsconn": {
            "request_key_map": {"cf_struct_name": "CFSTRUCT", "command_scope": "CMDSCOPE"},
            "request_value_map": {},
            "response_key_map": {},
            "response_value_map": {},
        },
        ...
        "tcluster": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "thread": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "topic": {
            "request_key_map": {
                "auth_record": "AUTHREC",
                "cap_expiry": "CAPEXPRY",
        ...
        "topicstr": {
            "request_key_map": {"clear_type": "CLRTYPE", "command_scope": "CMDSCOPE", "scope": "SCOPE"},
            "request_value_map": {},
            "response_key_map": {},
            "response_value_map": {},
        },
        "tpipe": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "tpstatus": {
            "request_key_map": {"command_scope": "CMDSCOPE", "status_type": "TYPE"},
            "request_value_map": {},
            "response_key_map": {
                "ACTCONN": "active_connection",
        ...
        "trace": {"request_key_map": {}, "request_value_map": {}, "response_key_map": {}, "response_value_map": {}},
        "usage": {
            "request_key_map": {"command_scope": "CMDSCOPE", "page_set_id": "PSID", "usage_type": "TYPE"},
            "request_value_map": {},
            "response_key_map": {},
            "response_value_map": {},
        },
