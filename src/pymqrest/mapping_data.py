...
MAPPING_DATA: dict[str, object] = {
    "commands": {
        ...
        "DELETE QALIAS": {"qualifier": "queue"},
        "DELETE QLOCAL": {"qualifier": "queue"},
        "DELETE QMODEL": {"qualifier": "queue"},
        "DELETE QREMOTE": {"qualifier": "queue"},
        ...
        "DISPLAY CHLAUTH": {"qualifier": "chlauth"},
        "DISPLAY CHSTATUS": {"qualifier": "chstatus"},
        ...
        "DISPLAY QMSTATUS": {"qualifier": "qmstatus", "response_parameter_macros": ["LOG"]},
        "DISPLAY QSTATUS": {"qualifier": "qstatus", "response_parameter_macros": ["MONITOR"]},
        "DISPLAY QUEUE": {"qualifier": "queue", "response_parameter_macros": ["CLUSINFO"]},
        ...
        "DISPLAY SUB": {"qualifier": "sub", "response_parameter_macros": ["SUMMARY"]},
    ...
    "qualifiers": {
        ...
        "queue": {
            ...
            "request_value_map": {
                "default_persistence": {"def": "DEF", "no": "NO", "not_fixed": "NOTFIXED", "yes": "YES"}
            },
            "response_key_map": {
                "ACCTQ": "queue_accounting",
                "ALTDATE": "alteration_date",
            ...
            "response_value_map": {"DEFPSIST": {"DEF": "def", "NO": "no", "NOTFIXED": "not_fixed", "YES": "yes"}},
        },
        "qstatus": {
            "request_key_map": {
                "command_scope": "CMDSCOPE",
