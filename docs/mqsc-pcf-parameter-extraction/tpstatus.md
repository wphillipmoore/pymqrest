# MQSC to PCF parameter extraction: Tpstatus
...
Collect MQSC and PCF parameter mappings for tpstatus commands, split from the first-run extraction to keep each qualifier readable.
